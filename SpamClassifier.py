...
data = data.append(dataFrameFromDirectory('C:/Users/Ritam/Desktop/DecemberBreak/emails/spam', 'spam'))
data = data.append(dataFrameFromDirectory('C:/Users/Ritam/Desktop/DecemberBreak/emails/ham', 'ham'))
...
exampleInput = ["Hey. This is John Cena. You can't see me", "Free exclusive goodies boys!!", "Please reply to get this offer"]
